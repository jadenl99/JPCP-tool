...
dir = "C://Users//jaden//Documents//GitHub//JPCP-tool//I16WB//2013//Slabs//output_range//" # Change this to the directory of the range images
...
dir = "C://Users//jaden//Documents//GitHub//JPCP-tool//I16WB//2013//Slabs//output_intensity//" # Change this to the directory of the 2013 intensity images
for filename in dir_list:
    number = int(filename.split('.')[0])
    if number >= 1536:
        os.rename(dir + filename, dir + str(number + 4) + '.jpg')           
...
# dir = "C://Users//jaden//Documents//GitHub//JPCP-tool//I16WB//2013//Slabs//output_segmentation//" # Change this to the directory of the 2013 intensity images
# for filename in dir_list:
#     number = int(filename.split('.')[0])
#     if number >= 1536:
#         os.rename(dir + filename, dir + str(number + 4) + '.jpg')            
