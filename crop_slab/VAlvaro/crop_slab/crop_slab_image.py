...
class CropSlabs:
    ...
    def crop(self):
        ...
        with open(self.csv_path, 'w', newline='') as range_csv:
            ...
            # First image slab cropping, bottom_im is the filepath of the xml
            # file of the first image
            curr_im = open(os.path.join(self.xml_path, self.xml_list[self.first_im]))
            bottom_soup = BeautifulSoup(curr_im, "lxml")
            ...
            # # TODO: consider modifying into two separate try/catch, one for
            # # joint and one for right joint
            # try:
            ...
            #     except:
            #         # last resort, if no vertical joints are found
